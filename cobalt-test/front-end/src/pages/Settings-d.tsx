            ...
            <div className="p-7">
              <form>
                ...
                <div className="mb-5 flex items-center gap-5">
                  <label className="block text-sm font-medium text-black dark:text-white">Notifications</label>
                ...
                {notificationsEnabled && (
                  <div className="mt-4 p-4 border border-dashed border-gray-300 rounded dark:border-gray-600">
                    <h4 className="mb-2 text-sm font-semibold text-black dark:text-white">Notification Settings</h4>
                    ...
                    <ul className="mt-2 space-y-2">
                      ...
                      <li>
                        <label className="flex items-center gap-3">
                          <input type="checkbox" className="form-checkbox h-4 w-4 text-primary" />
                          <span className="text-sm text-black dark:text-white">SMS Notifications</span>
                        </label>
                      </li>
                    </ul>
                  </div>
