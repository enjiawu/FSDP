...
const applicationResults: ApplicationResult[] = [
  {
    ...
    testCases: [
      ...
      { id: 102, browser: "Firefox", timeTaken: "15s", name: "Password Reset", description: "Checks password reset flow", status: "Passed" },
      { id: 103, browser: "Safari", timeTaken: "10s", name: "Session Timeout", description: "Validates session timeout", status: "Passed" },
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    status: "Passed",
    testCases: [
      { id: 301, browser: "Safari", timeTaken: "18s", name: "Edit Profile", description: "Validates profile editing", status: "Passed" },
      { id: 302, browser: "Chrome", timeTaken: "22s", name: "Profile Picture Upload", description: "Tests image upload", status: "Passed" },
    ],
  },
  {
    id: 4,
    ...
    status: "Passed",
    testCases: [
      { id: 401, browser: "Chrome", timeTaken: "14s", name: "View Orders", description: "Tests order history page", status: "Passed" },
