...
const AddTestCase: React.FC = () => {
    ...
    return (
        <div className="sm:px-7.5 col-span-12 rounded-md border border-stroke bg-white px-5 pb-5 pt-7.5 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-5">
            ...
            <div className="flex">
                ...
                <div className="w-2/3 mr-10">
                    ...
                    >
                        {fileState.isUploading ? 'Uploading...' : 'Add Test Case'}
                    </button>
                </div>
