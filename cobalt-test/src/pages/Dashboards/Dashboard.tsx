  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-4 md:gap-6 xl:gap-7.5">
        ...
        <div className="col-span-1 md:col-span-1 xl:col-span-1 p-4 border rounded-lg shadow-lg bg-white">
          <h3 className="text-xl font-bold mb-2 ">Test Application</h3>
          <button className="bg-primary text-white px-4 py-2 w-full rounded hover:bg-red-700">Run Test</button>
        </div>

        {/* Testing Schedule Card */}
        <div className="col-span-1 md:col-span-3 xl:col-span-3 p-4 border rounded-lg shadow-lg bg-white">
          <div className="flex items-center">
            ...
            <h4 className="text-lg font-semibold">Testing Schedule</h4>
          </div>
          <div className="mt-2">
            <p className="text-gray-700"><strong>Automated tests run nightly at midnight</strong> to ensure software integrity. This identifies regressions and helps maintain a stable build. Results allow the team to address issues promptly, ensuring a smoother user experience and minimizing disruptions.</p>
          </div>
        </div>
      </div>
